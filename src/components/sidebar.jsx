                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 448 512"
                      class="svg-inline--fa fa-facebook fa-w-14 fa-7x"
                      width="32px"
                      height="32px"
                    >
                      <path
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                      class="svg-inline--fa fa-twitter fa-w-16 fa-7x"
                      width="32px"
                      height="32px"
                    >
                      <path
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                      class="svg-inline--fa fa-linkedin fa-w-14 fa-7x"
                      width="32px"
                      height="32px"
                    >
                      <path
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 496 512"
                      class="svg-inline--fa fa-github fa-w-16 fa-7x"
                      width="32px"
                      height="32px"
                    >
                      <path
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 369 512"
                      class="svg-inline--fa fa-strava fa-w-12 fa-7x"
                      width="32px"
                      height="32px"
                    >
                      <path

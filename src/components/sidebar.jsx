                ...
                <li className="social-logos">
                  <a href="https://www.facebook.com/paloskar" target="_blank" rel="noopener noreferrer">
                    <svg
                      ...
                      viewBox="0 0 448 512"
                      className="svg-inline--fa fa-facebook fa-w-14 fa-7x"
                      width="32px"
                      height="32px"
                    >
                      <path
                ...
                <li className="social-logos">
                  <a href="https://www.instagram.com/paloskar" target="_blank" rel="noopener noreferrer">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                      className="svg-inline--fa fa-instagram fa-w-14 fa-7x"
                      width="32px"
                      height="32px"
                    >
                      <path
                ...
                <li className="social-logos">
                  <a href="https://www.linkedin.com/in/paloskar" target="_blank" rel="noopener noreferrer">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                      className="svg-inline--fa fa-linkedin fa-w-14 fa-7x"
                      width="32px"
                      height="32px"
                    >
                      <path
                ...
                <li className="social-logos">
                  <a href="https://www.strava.com/athletes/2242743" target="_blank" rel="noopener noreferrer">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 369 512"
                      className="svg-inline--fa fa-strava fa-w-12 fa-7x"
                      width="32px"
                      height="32px"
                    >
                      <path
